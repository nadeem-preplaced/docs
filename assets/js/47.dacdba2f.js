...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "dyte_full_grid": () => (/* binding */ DyteFullGrid)
/* harmony export */ });
/* harmony import */ var _index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(13441);
/* harmony import */ var _index_560ccbe9_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8198);
...
const dyteFullGridCss = ".scrollbar{scrollbar-width:thin;scrollbar-color:var(--dyte-scrollbar-color, rgb(var(--dyte-colors-background-600, 60 60 60)))\n    var(--dyte-scrollbar-background, transparent)}.scrollbar::-webkit-scrollbar{height:var(--dyte-space-1\\.5, 6px);width:var(--dyte-space-1\\.5, 6px);border-radius:9999px;background-color:var(--dyte-scrollbar-background, transparent)}.scrollbar::-webkit-scrollbar-thumb{border-radius:9999px;background-color:var(--dyte-scrollbar-color, rgb(var(--dyte-colors-background-600, 60 60 60)))}:host{display:flex;height:100%;width:100%;padding:var(--dyte-space-2, 8px)}:host main{display:flex;flex:1 1 0%;flex-direction:row-reverse}:host main .active-tab{margin-left:var(--dyte-space-3, 12px);margin-right:var(--dyte-space-3, 12px);display:flex;flex:1 1 0%;flex-direction:column}:host main .active-tab>*{height:100%;width:100%}:host main .switcher{display:flex;height:100%;width:var(--dyte-space-20, 80px);flex-direction:column}:host main .switcher .list{display:flex;flex:1 1 0%;flex-direction:column;align-items:center;overflow-y:auto;flex-basis:0}:host main .switcher .list>*{margin-bottom:var(--dyte-space-2, 8px)}:host main .switcher .list>*:last-child{margin-bottom:var(--dyte-space-0, 0px)}:host main .switcher dyte-button{height:var(--dyte-space-16, 64px);width:var(--dyte-space-16, 64px);--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-background-600, 60 60 60) / var(--tw-bg-opacity))}:host main .switcher dyte-button dyte-icon{height:var(--dyte-space-8, 32px);width:var(--dyte-space-8, 32px)}:host main .switcher dyte-button img{height:var(--dyte-space-8, 32px);width:var(--dyte-space-8, 32px)}:host main .switcher dyte-button .name{font-size:12px;overflow:hidden;display:-webkit-box;-webkit-box-orient:vertical;-webkit-line-clamp:1}:host main .switcher dyte-button.active{--tw-bg-opacity:1;background-color:rgba(var(--dyte-colors-brand-500, 33 96 253) / var(--tw-bg-opacity))}:host aside{display:flex;height:100%;width:var(--dyte-space-72, 288px);flex-direction:column}:host aside .list{display:flex;flex:1 1 0%;flex-direction:column;overflow-y:scroll;padding-right:var(--dyte-space-1, 4px);flex-basis:0}:host aside dyte-peer-view{margin-bottom:var(--dyte-space-2, 8px);height:auto;width:100%;flex-shrink:0}:host aside dyte-peer-view:last-child{margin-bottom:var(--dyte-space-0, 0px)}:host([size='sm']){flex-direction:column}:host([size='sm']) main{flex-shrink:0;flex-direction:column;flex-basis:0}:host([size='sm']) main .active-tab{margin-left:var(--dyte-space-1, 4px);margin-right:var(--dyte-space-1, 4px)}:host([size='sm']) main .switcher{margin-top:var(--dyte-space-2, 8px);margin-bottom:var(--dyte-space-2, 8px);margin-left:var(--dyte-space-1, 4px);margin-right:var(--dyte-space-1, 4px);height:var(--dyte-space-20, 80px);width:auto;flex-direction:row}:host([size='sm']) main .switcher .list{margin-left:auto;margin-right:auto;width:var(--dyte-space-10, 40px);flex-direction:row;align-items:center;overflow-x:auto;flex-basis:1}:host([size='sm']) main .switcher .list dyte-button{margin-bottom:var(--dyte-space-0, 0px);margin-right:var(--dyte-space-2, 8px);height:var(--dyte-space-14, 56px);width:var(--dyte-space-14, 56px);flex-shrink:0}:host([size='sm']) main .switcher .list dyte-button:last-child{margin-right:var(--dyte-space-0, 0px)}:host([size='sm']) aside{height:var(--dyte-space-32, 128px);width:auto;flex-direction:row}:host([size='sm']) aside .list{display:flex;width:var(--dyte-space-10, 40px);flex-direction:row;overflow-x:auto;padding-right:var(--dyte-space-0, 0px)}:host([size='sm']) aside .list dyte-peer-view{margin-bottom:var(--dyte-space-0, 0px);margin-right:var(--dyte-space-2, 8px);height:100%;width:auto}:host([size='sm']) aside .list dyte-peer-view:last-child{margin-right:var(--dyte-space-0, 0px)}.col-center{display:flex;flex:1 1 0%;flex-direction:column;align-items:center;justify-content:center}.col-center>*:last-child{margin-top:var(--dyte-space-1, 4px)}.col-center img{border-radius:var(--dyte-border-radius-sm, 4px)}";

const DyteFullGrid = class {
  constructor(hostRef) {
    ...
    this.gap = 10;
    /** Config object */
    this.config = _index_560ccbe9_js__WEBPACK_IMPORTED_MODULE_1__.d;
    /** Icon pack */
  ...
  render() {
    ...
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("main", null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "active-tab" }, this.activeTab &&
      (this.activeTab.type === 'screenshare' ? ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_560ccbe9_js__WEBPACK_IMPORTED_MODULE_1__.R, { element: "dyte-screenshare-view", defaults: defaults, props: {
          key: this.activeTab.peer.id,
          peer: this.activeTab.peer,
        }, childProps: { peer: this.activeTab.peer, isScreenShare: true }, deepProps: true })) : ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_560ccbe9_js__WEBPACK_IMPORTED_MODULE_1__.R, { element: "dyte-plugin-main", defaults: defaults, props: { key: this.activeTab.plugin.id, plugin: this.activeTab.plugin } })))), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "switcher" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "list scrollbar" }, this.screenSharePeers.map((peer) => {
      const name = (0,_string_739d5cc6_js__WEBPACK_IMPORTED_MODULE_4__.f)(peer.name);
      return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { title: `${name}'s Screen Share`, key: peer.id, kind: "icon", class: {
          active: this.activeTab.type === 'screenshare' && this.activeTab.peer.id === peer.id,
        }, onClick: () => (this.activeTab = { type: 'screenshare', peer }) }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "col-center" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.share_screen_person }), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "name" }, peer.id === this.meeting.self.id ? 'You' : (0,_string_739d5cc6_js__WEBPACK_IMPORTED_MODULE_4__.s)(name, 6)))));
    }), this.plugins.map((plugin) => ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { title: plugin.name, key: plugin.id, kind: "icon", class: {
        active: this.activeTab.type === 'plugin' && this.activeTab.plugin.id === plugin.id,
      }, onClick: () => (this.activeTab = { type: 'plugin', plugin }) }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "col-center" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("img", { src: plugin.picture }), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "name" }, (0,_string_739d5cc6_js__WEBPACK_IMPORTED_MODULE_4__.s)(plugin.name, 6))))))))), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "list scrollbar" }, this.peers.map((peer) => ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_560ccbe9_js__WEBPACK_IMPORTED_MODULE_1__.R, { element: "dyte-peer-view", defaults: defaults, props: { key: peer.id, peer, size: 'sm' }, childProps: { peer, size: 'sm' }, deepProps: true })))))));
  }
  static get watchers() { return {
    "screenSharePeers": ["screenSharePeersChanged"],
    "plugins": ["pluginsChanged"]
  }; }
};
DyteFullGrid.style = dyteFullGridCss;
