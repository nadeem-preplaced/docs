...
const dyteParticipantCountCss = ":host{display:inline-flex;height:var(--dyte-space-10, 40px);width:var(--dyte-space-10, 40px);align-items:center;padding:var(--dyte-space-1, 4px);font-family:var(--dyte-font-family, sans-serif)}dyte-icon{margin-right:var(--dyte-space-1, 4px);height:60%;width:auto}";
...
const DyteParticipantCount = class {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      this.countListener = () => {
        this.participantCount = meeting.participants.joined.size + (meeting.meta.joined ? 1 : 0);
      };
      this.countListener();
  ...
  render() {
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, { tabIndex: 0, role: "log", "aria-label": `${this.participantCount} ${this.t('participants')}` }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.people, tabIndex: -1, "aria-hidden": true }), this.participantCount));
  }
