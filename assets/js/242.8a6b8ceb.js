...
const dyteAudioVisualizerCss = ":host{display:block;height:var(--dyte-space-6, 24px);width:var(--dyte-space-6, 24px)}canvas,dyte-icon{height:100%;width:100%}:host([size='sm']){transform:scale(0.9)}canvas{display:none}canvas.visible{display:block}";
...
const DyteAudioVisualizer = class {
  ...
  disconnectedCallback() {
    ...
    this.audioUpdateListener && ((_b = this.peer) === null || _b === void 0 ? void 0 : _b.removeListener('audioUpdate', this.audioUpdateListener));
    this.previewUpdateListener &&
      ((_c = this.peer) === null || _c === void 0 ? void 0 : _c.removeListener('previewUpdate', this.previewUpdateListener));
    this.screenShareUpdateListener &&
      ((_d = this.peer) === null || _d === void 0 ? void 0 : _d.removeListener('screenShareUpdate', this.screenShareUpdateListener));
  }
  peerChanged(peer) {
    if (peer != null) {
      ...
      if (this.isScreenShare) {
        ...
        this.screenShareUpdateListener(peer);
        peer.addListener('screenShareUpdate', this.screenShareUpdateListener);
      }
      else if (this.isPreview) {
        this.previewUpdateListener = ({ preview }) => {
          this.audioUpdateListener(preview);
        };
        this.previewUpdateListener(peer);
        peer.addListener('previewUpdate', this.previewUpdateListener);
      }
      else {
        this.audioUpdateListener(peer);
  ...
  render() {
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("canvas", { width: "24", height: "24", class: {
        bars: true,
        visible: this.audioEnabled,
      }, ref: (el) => (this.visualizer = el) }), !this.audioEnabled && (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.mic_off })));
  }
