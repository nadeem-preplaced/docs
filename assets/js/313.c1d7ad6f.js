...
const dytePluginsToggleCss = ":host{display:block}";
...
const DytePluginsToggle = class {
  ...
  statesChanged(states) {
    if (states != null) {
      this.pluginsActive = this.states.activeSidebar && this.states.sidebar === 'plugins';
    }
  }
  togglePlugins() {
    this.pluginsActive = !(this.states.activeSidebar && this.states.sidebar === 'plugins');
  ...
  render() {
    ...
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { class: { active: this.pluginsActive }, size: this.size, onClick: () => this.togglePlugins(), icon: this.iconPack.rocket, label: text })));
  }
