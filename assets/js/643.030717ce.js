...
const dyteClockCss = ":host{margin:var(--dyte-space-2, 8px);display:inline-flex;align-items:center;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;font-size:14px;font-variant-numeric:tabular-nums}dyte-icon{margin-right:var(--dyte-space-1, 4px);height:var(--dyte-space-5, 20px);width:var(--dyte-space-5, 20px)}";
...
const DyteClock = class {
  ...
  render() {
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, { tabIndex: 0, role: "timer", "aria-live": "off" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.clock, "aria-hidden": true, tabIndex: -1 }), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", null, this.getFormattedTime())));
  }
