...
const dyteParticipantsToggleCss = ":host{display:block}";
...
const DyteParticipantsToggle = class {
  ...
  statesChanged(states) {
    if (states != null) {
      this.participantsActive = this.states.activeSidebar && this.states.sidebar === 'participants';
    }
  }
  ...
  render() {
    ...
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { class: { active: this.participantsActive }, size: this.size, onClick: () => this.toggleParticipantsTab(), icon: this.iconPack.participants, label: text })));
  }
