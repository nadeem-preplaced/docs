...
const DyteCameraToggle = class {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      ...
      this.canProduceVideo = self.permissions.produceVideo.allow;
  ...
  render() {
    ...
    const text = this.t(this.videoEnabled ? 'video_on' : 'video_off');
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, class: {
        'red-icon': !this.videoEnabled,
      }, onClick: () => this.toggleCamera(), icon: this.videoEnabled ? this.iconPack.video_on : this.iconPack.video_off, label: text })));
  }
...
const DyteMicToggle = class {
  ...
  meetingChanged(meeting) {
    if (meeting != null) {
      const self = meeting.self;
      this.canProduceAudio = self.permissions.produceAudio;
  ...
  render() {
    ...
    const text = this.t(this.audioEnabled ? 'mic_on' : 'mic_off');
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, { title: text }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-controlbar-button", { size: this.size, class: {
        'red-icon': !this.audioEnabled,
      }, onClick: () => this.toggleMic(), icon: this.audioEnabled ? this.iconPack.mic_on : this.iconPack.mic_off, label: text })));
  }
  static get watchers() { return {
    "meeting": ["meetingChanged"]
  }; }
