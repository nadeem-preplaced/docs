...
const DyteGridPagination = class {
  ...
  render() {
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "prev", variant: "outline", kind: "icon", disabled: this.pageCount === 0, onClick: () => this.prevPage(), "aria-label": this.t('Previous Page') }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_left })), this.variant !== 'grid' && ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "center" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "page" }, this.pageCount === 0 ? ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-tooltip", { label: this.t('Auto Layout') }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", class: "auto" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.wand })))) : (this.page)), this.pageCount !== 0 && [
      (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "slash" }, "/"),
      (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("span", { class: "pages" }, this.pageCount),
    ])), this.variant === 'grid' && this.pageCount > 0 && ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "dots" }, [...Array(this.pageCount)].map((_, index) => ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { key: `dot-${index}`, class: { dot: true, active: index + 1 === this.page } }))))), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { class: "next", variant: "outline", kind: "icon", disabled: this.page !== 0 && this.page === this.pageCount, onClick: () => this.nextPage(), "aria-label": this.t('Next Page') }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_right, tabIndex: -1, "aria-hidden": true }))));
  }
