...
class DyteNotificationsAudio {
  ...
  play(sound, duration = 3000) {
    ...
    (_a = this.audio.play()) === null || _a === void 0 ? void 0 : _a.catch((err) => {
      _logger_5472d03c_js__WEBPACK_IMPORTED_MODULE_1__.l.error('[dyte-notifications] play() failed\n', { sound, duration }, err);
    });
    setTimeout(() => {
      this.playing = false;
    }, duration);
  ...
  async setDevice(id) {
    ...
    await ((_c = (_b = (_a = this.audio) === null || _a === void 0 ? void 0 : _a.setSinkId) === null || _b === void 0 ? void 0 : _b.call(_a, id)) === null || _c === void 0 ? void 0 : _c.catch((err) => {
      _logger_5472d03c_js__WEBPACK_IMPORTED_MODULE_1__.l.error('[dyte-notifications] setSinkId() error\n', err);
    }));
  }
}
...
const DyteNotifications = class {
    ...
    if (meeting != null) {
      ...
      this.participantJoinedListener = (peer) => {
        if (this.notificationPermissions.participant_joined) {
          this.add({
            id: `${peer.id}-joined`,
            message: `${(0,_string_739d5cc6_js__WEBPACK_IMPORTED_MODULE_4__.f)(peer.name)} just joined`,
            image: peer.picture,
            duration: 2100,
          });
        }
      ...
      this.participantLeftListener = (peer) => {
        if (this.notificationPermissions.participant_left) {
          this.add({
            id: `${peer.id}-left`,
            message: `${(0,_string_739d5cc6_js__WEBPACK_IMPORTED_MODULE_4__.f)(peer.name)} left`,
            image: peer.picture,
            duration: 2100,
          });
        }
          ...
          if (message.type === 'text') {
            if (this.notificationPermissions.chat) {
              this.add({
                ...
                message: `${message.displayName}: ${(0,_string_739d5cc6_js__WEBPACK_IMPORTED_MODULE_4__.s)(message.message, 20)}`,
                duration: 2000,
              });
            }
  ...
  handleDismiss(e) {
    ...
    setTimeout(() => {
      (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.w)(() => {
        this.remove(id);
      });
    }, 400);
  }
  render() {
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, this.notifications.map((notification) => ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-notification", { size: this.size, key: notification.id, "data-id": notification.id, notification: notification, onDismiss: (e) => this.handleDismiss(e) })))));
  }
