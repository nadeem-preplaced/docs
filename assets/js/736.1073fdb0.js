...
const DyteSettings = class {
  ...
  disconnectedCallback() {
    var _a, _b;
    (_a = this.meeting) === null || _a === void 0 ? void 0 : _a.self.disablePreview();
    this.keyPressListener && document.removeEventListener('keydown', this.keyPressListener);
    this.poorConnectionListener &&
      ((_b = this.meeting) === null || _b === void 0 ? void 0 : _b.meta.removeListener('poorConnection', this.poorConnectionListener));
  }
  meetingChanged(meeting) {
    if (meeting != null) {
      this.canProduceAudio = meeting.self.permissions.produceAudio;
      this.canProduceVideo = meeting.self.permissions.produceVideo.allow;
      ...
      this.meeting.meta.addListener('poorConnection', this.poorConnectionListener);
    }
  }
  changeTab(tab) {
    this.activeTab = tab;
  ...
  render() {
    ...
    return ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)(_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.H, null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", class: "dismiss-btn", onClick: () => this.close() }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.dismiss })), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("aside", { class: { hide: this.isMobileMainVisible } }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, this.t('settings'))), this.canProduceAudio && ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: { active: this.activeTab === 'audio' }, onClick: () => this.changeTab('audio') }, this.t('audio'), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.mic_on }), this.size === 'sm' && (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_right })))), this.canProduceVideo && ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "button", class: { active: this.activeTab === 'video' }, onClick: () => this.changeTab('video') }, this.t('video'), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.video_on }), this.size === 'sm' && (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_right })))), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("button", { type: "none", title: `Your network condition is ${this.networkStatus}` }, this.t('connection'), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("div", { class: "right" }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.wifi, class: this.networkStatus })))), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("main", { class: { active: this.isMobileMainVisible } }, this.size === 'sm' && ((0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("header", null, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-button", { kind: "icon", class: "back-btn", onClick: () => (this.isMobileMainVisible = false) }, (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-icon", { icon: this.iconPack.chevron_left })), (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("h2", null, this.t(this.activeTab === 'audio' ? 'audio' : 'video')))), this.activeTab === 'audio' && (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-settings-audio", Object.assign({}, defaults)), this.activeTab === 'video' && (0,_index_da7bf46b_js__WEBPACK_IMPORTED_MODULE_0__.h)("dyte-settings-video", Object.assign({}, defaults)))));
  }
